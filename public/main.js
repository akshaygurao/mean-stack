...
var appRoutes = [
    ...
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] }
];
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('http://localhost:3000/users/register', user, { headers: headers })
            .map(function (res) { return res.json(); }).catch(function (error) { return rxjs_Rx__WEBPACK_IMPORTED_MODULE_2__["Observable"].throw(error.json().error || 'Server error'); });
    };
...
module.exports = __webpack_require__(/*! /home/akshaygurao/meanauthapp/angular-src/src/main.ts */"./src/main.ts");
